...
An example utilization of the `scream` monorepo manager.

Commands to reproduce this repo...
...
scream init
> Initialized empty Git repository in /Users/rk/py/scream_monorepo_example/.git/
> INFO - Done!
